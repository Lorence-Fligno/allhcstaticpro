...
selector.closest('.uabb-video__outer-wrap').find('.uabb-vimeo-wrap').hide();},}})(jQuery);;jQuery(document).ready(function(){new UABBVideo({id:'ray8p0h1493u',vsticky:'',sticky_hide_on:'none',small_breakpoint:768,medium_breakpoint:992,stickybottom:0,});});